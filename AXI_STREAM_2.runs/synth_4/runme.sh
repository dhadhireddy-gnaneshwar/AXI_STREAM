...
HD_PWD='C:/Users/demon/INTERNSHIP/src_sim_vivado/AXI_STREAM_2/AXI_STREAM_2.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log axi_stream.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_stream.tcl
